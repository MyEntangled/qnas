...
#     shape_distance = pd.read_csv('~/Dropbox/URP project/Code/PQC_composer/gate_distance/gate_shape_distance.csv',header=None).values
#     core_distance = pd.read_csv('~/Dropbox/URP project/Code/PQC_composer/gate_distance/gate_core_distance.csv',header=None).values
